...
class D9SOAWORKSTRONGMNGD_API Manhourmanageservice
{
public:
    ...
    private:
        ...
        void serialize( Teamcenter::Soa::Client::CdmStream* _cdmStream, const std::string& elementName="ManHourEntry" ) const;
        void parse    ( Teamcenter::Soa::Client::CdmParser* _cdmParser );
    };
    ...
    private:
        ...
        void serialize( Teamcenter::Soa::Client::CdmStream* _cdmStream, const std::string& elementName="ManHourProgram" ) const;
        void parse    ( Teamcenter::Soa::Client::CdmParser* _cdmParser );
    };
