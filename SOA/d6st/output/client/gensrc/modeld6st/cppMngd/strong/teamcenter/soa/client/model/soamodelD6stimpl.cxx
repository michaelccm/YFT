...
Teamcenter::Soa::Common::AutoPtr<Schedule> Teamcenter::Soa::Client::Model::D6MheTask::get_d6Schedule_tag()
{
    Teamcenter::Soa::Common::AutoPtr<Teamcenter::Soa::Client::ModelObject> temp = getProperty("d6Schedule_tag")->getModelObjectValue();
    Teamcenter::Soa::Common::AutoPtr<Schedule> ret = temp.dyn_cast< Schedule >();
