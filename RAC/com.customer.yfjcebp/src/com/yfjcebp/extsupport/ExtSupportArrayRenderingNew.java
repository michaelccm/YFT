...
public class ExtSupportArrayRenderingNew extends AbstractPropertyBean{
	...
	public ExtSupportArrayRenderingNew(FormToolkit paramFormToolkit, Composite paramComposite, boolean paramBoolean, Map paramMap) {
	...
	public void load(TCComponent tccomponent) throws Exception {
		...
		if (tccomponent instanceof TCComponentForm) {
			...
			mFrame.add(sectionManager, BorderLayout.CENTER);
