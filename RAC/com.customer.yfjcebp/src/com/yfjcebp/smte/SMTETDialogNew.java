...
import com.teamcenter.rac.stylesheet.PropertyArray1;
...
public class SMTETDialogNew extends AbstractPropertyBean
    
{
    ...
    public SMTETDialogNew(FormToolkit paramFormToolkit, Composite paramComposite, boolean paramBoolean, Map paramMap)
    {
        ...
        mFrame.add("1.2.right.top",array);
        mFrame.add("1.1.left.top", jbutton);
