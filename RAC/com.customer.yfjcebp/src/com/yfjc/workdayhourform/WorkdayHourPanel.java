...
public class WorkdayHourPanel extends JPanel implements ActionListener {
	...
	public WorkdayHourPanel(WorkdayHourDialog dialog, TCSession session,
...
//			defaultHour = Double.valueOf(defaultNorHours);
	 ...
	 * @param t
	 */
	public WorkdayHourPanel(boolean isprocess, boolean isEdit,
