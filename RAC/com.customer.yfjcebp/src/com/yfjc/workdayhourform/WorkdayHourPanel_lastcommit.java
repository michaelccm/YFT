...
public class WorkdayHourPanel_lastcommit extends JPanel implements ActionListener {
	...
	public WorkdayHourPanel_lastcommit(WorkdayHourDialog dialog, TCSession session,
...
//			defaultHour = Double.valueOf(defaultNorHours);
	 ...
	 * @param t
	 */
	public WorkdayHourPanel_lastcommit(boolean isprocess, boolean isEdit,
