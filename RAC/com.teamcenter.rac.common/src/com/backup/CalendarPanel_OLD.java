...
//
//public class CalendarPanel_OLD extends JPanel
...
//  //end by YFJC
//  public CalendarPanel_OLD()
//  {
//	System.out.println("CalendarPanel ");
...
//  }
//
//  public CalendarPanel_OLD(Date paramDate)
//  {
...
//  }
//
//  public CalendarPanel_OLD(Date paramDate, SimpleDateFormat paramSimpleDateFormat)
//  {
...
//  {
//	System.out.println("setTime  paramDate");
//    if (paramDate == null)
//      paramDate = new Date();
...
//      String[] s1 = { "BillType", "OwningUser", "CreateAfter", "CreateBefore" };
...
//                  else
//                  {
//                    Vector v = CalendarPanel.this.calHours(true, CalendarPanel.this.calendar
//                      .get(1), CalendarPanel.this.calendar
//                      .get(2) + 1, this.number);
//
//                    if ((v != null) && (v.size() > 0)) {
//                      s = v.elementAt(0) + ";" + 
//                        v.elementAt(1);
//                      int h = Integer.parseInt(v.elementAt(0)
//                        .toString());
